...
<div style="padding:0">
    <div class="card" style="max-width:640px; margin:0 auto; padding:32px;">
        ...
        <div style="margin-bottom:24px;">
            ...
            <div class="page-subtitle">Update expense details</div>
        </div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                    <div class="form-group">
                        ...
                        <select name="category" id="category-select"
                            ...
                            <option value="raw_materials" {{ $expense->category == 'raw_materials' ? 'selected' : '' }}>Raw Materials</option>
                            <option value="masala" {{ $expense->category == 'masala' ? 'selected' : '' }}>Masala</option>
                            <option value="salary" {{ $expense->category == 'salary' ? 'selected' : '' }}>Salary</option>
                            <option value="packing_materials" {{ $expense->category == 'packing_materials' ? 'selected' : '' }}>Packing Materials</option>
                            <option value="cleaning_materials" {{ $expense->category == 'cleaning_materials' ? 'selected' : '' }}>Cleaning Materials</option>
                            <option value="petty_cash" {{ $expense->category == 'petty_cash' ? 'selected' : '' }}>Petty Cash</option>
                            <option value="utilities" {{ $expense->category == 'utilities' ? 'selected' : '' }}>Utilities</option>
                            <option value="maintenance_repairs" {{ $expense->category == 'maintenance_repairs' ? 'selected' : '' }}>Maintenance and Repairs</option>
